...
class homePage:
    def __init__(self, root):
        ...
        self.btn_users = Button(LeftMenu, command=self.user_details, state=DISABLED, text="Users", image=self.icon_side, compound=LEFT,padx=5, anchor="w", font=("times new roman", 16, "bold"), bg="white", bd=2,cursor="hand2")
